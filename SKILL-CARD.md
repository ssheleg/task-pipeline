...
3. Run `npm run test:all` — 75 guards, each with a negative self-test that plants a
...
- **Behavioural evidence is missing, not merely thin.** 75 structural guards prove
