...
3. Run `npm run test:all` — 100 guards, each with a negative self-test that plants a
...
- **Behavioural evidence is missing, not merely thin.** 100 structural guards prove
