...
3. Run `npm run test:all` — 46+ guards, each with a negative self-test that plants a
...
- **Behavioural evidence is missing, not merely thin.** 46 structural guards prove
