...
and the stage-5 guard widened from one precondition to all three — guards 318 → **333**.
...
**The reading that would have been wrong.** Three intermediate runs of `negatives.py`
disagreed with each other — 1, 2, 3 and 4 guards down across four runs of an unchanged
tree — and *the suite is flaky* was available and false. Two suite runs were overlapping,
