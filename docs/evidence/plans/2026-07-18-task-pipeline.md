...
> this plan (mandatory built-in stage-0 grill with domain awareness and an
> autonomy sweep, typed gates, super-ux track, provider-agnostic model policy,
> npm installer, toggleable release). Current state: `CHANGELOG.md` + `SKILL.md`
> + `references/grill.md`. Kept as a dated record.
